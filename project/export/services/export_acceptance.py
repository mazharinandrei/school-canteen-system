...
def generate_acceptance_file():
    ...
    return create_acceptance_file(
        date=date, acceptances=acceptance, file_path=file_path
    )
...
def create_acceptance_file(ws, date, acceptances, file_path):
    ...
    for acceptance in acceptances:
        ...
        insert_row(
            ...
            row_index=i,
            data=(
                acceptance.warehouse.name,
                str(acceptance.contract),
